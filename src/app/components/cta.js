...
const CTA = () => {
    return (
        <section className='py-16 px-6 bg-gray-50'>
            <div className='max-w-4xl mx-auto text-center bg-white border border-blue-400 py-8 px-4 lg:p-8 rounded-lg '>
                ...
                <p className='text-gray-600 text-lg sm:text-xl mb-8 break-all'>
